...
public class IOCcam : MonoBehaviour {
	public string tags = "IOC";
	public LayerMask layerMsk;
	public int occludeeLayer;
	public int samples = 100;
	public float raysFov = 70;
	public bool preCullCheck = true;
	public float viewDistance = 1000;
	public int hideDelay = 15;
	public bool realtimeShadows = true;
	public float lod1Distance = 80;
	public float lod2Distance = 240;
	public int lightProbes = 300;
	...
	void Start () {
		...
		layerMsk = LayerMask.GetMask("WorldCollide");
	}
